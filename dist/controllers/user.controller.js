...
exports.createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newEntity, results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newEntity = typeorm_1.getRepository(User_1.User).create(req.body);
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).save(newEntity)];
            case 1:
                results = _a.sent();
                return [2 /*return*/, res.json(results)];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                typeorm_1.getRepository(User_1.User).merge(entity, req.body);
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).save(entity)];
            case 2:
                results = _a.sent();
                return [2 /*return*/, res.json(results)];
